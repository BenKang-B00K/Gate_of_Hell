...
const enemyCategories = {
    ...
    corrupted: [
        { type: 'defiled_apprentice', icon: '🥀', speed: 0.6, hp: 400, defense: 5, probability: 0, desc: "A trainee who touched forbidden arts. 10% chance to curse attacker's damage (-3, No stack).", effectiveness: "Avoid using high-tier units to minimize curse risk.", lore: "One moment of weakness, one forbidden scroll, and a soul is lost forever to the shadows." },
