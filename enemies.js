...
const enemyCategories = {
    ...
    enhanced: [
        ...
        { type: 'lightspeed', icon: '✨', speed: 3.2, hp: 60, defense: 0, probability: 0.3, reward: 18, desc: "Moves at incredible speed and ignores speed-boosting auras.", effectiveness: "Instant-kill guardians or void snipers.", lore: "A messenger who failed to deliver a life-saving word, now desperate to reach the end." } 
    ],
    armoured: [
