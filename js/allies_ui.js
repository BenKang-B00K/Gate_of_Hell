        ...
        ch = `
            ...
            <div style="font-size:30px; display:flex; gap:36px; justify-content:center; margin-bottom:18px;">
                <div style="display:flex; flex-direction:column; align-items:center; gap:6px; position:relative;">
                    <button class="info-promo-btn" onclick="if(money>=200) performJobChange(null, 'Attack', true)" onmouseenter="if(money<200) this.nextElementSibling.style.display='block'" onmouseleave="this.nextElementSibling.style.display='none'" title="Ascend to Attack Path">⚔️</button>
                ...
                <div style="display:flex; flex-direction:column; align-items:center; gap:6px; position:relative;">
                    <button class="info-promo-btn" onclick="if(money>=200) performJobChange(null, 'Support', true)" onmouseenter="if(money<200) this.nextElementSibling.style.display='block'" onmouseleave="this.nextElementSibling.style.display='none'" title="Ascend to Support Path">🪄</button>
                    <div class="card-warning" style="font-size:12px; top:-40px; pointer-events:none;">NOT ENOUGH SE</div>
                    <div style="font-size:21px; color:#00e5ff;">Support</div>
                </div>
                <div style="display:flex; flex-direction:column; align-items:center; gap:6px; position:relative;">
                    <button class="info-promo-btn" onclick="if(money>=200) performJobChange(null, 'Special', true)" onmouseenter="if(money<200) this.nextElementSibling.style.display='block'" onmouseleave="this.nextElementSibling.style.display='none'" title="Ascend to Special Path">💠</button>
                    <div class="card-warning" style="font-size:12px; top:-40px; pointer-events:none;">NOT ENOUGH SE</div>
