...
const enemyCategories = {
    ...
    armoured: [
        ...
        { type: 'bringer_of_doom', icon: '⛓️‍💥', speed: 0.3, hp: 2200, defense: 20, probability: 0.1, reward: 150, desc: "슬롯 데미지를 영구 감소시킵니다.", effectiveness: "최우선 처치.", lore: "대지가 비명을 지르는 파멸의 인도자입니다." }
    ],
    treasure: [
